// import 'package:WiwaApp/Music/FrontEnd/Screens/Library/downloaded.dart';
...
class _LibraryPageState extends State<LibraryPage> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        AppBar(
          title: Text('Library', style: TextStyle(color: Colors.black54)),
          centerTitle: true,
