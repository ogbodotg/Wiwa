            ...
            child: Scaffold(
              ...
              body: StreamBuilder<bool>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return !running
                        ? EmptyScreen().emptyScreen(context, 3, " ", 13.0,
                            "No song playing", 15, "Go Play a song", 18.0)
...
//                     final running = snapshot.data ?? false;
//                     return !running
//                         ? EmptyScreen().emptyScreen(context, 3, " ", 18.0,
//                             "No song playing", 60, "Go Play a Song", 23.0)
//                         : StreamBuilder<List<MediaItem>>(
//                             stream: AudioService.queueStream,
//                             builder: (context, snapshot) {
//                               final queue = snapshot.data;
