...
import 'package:wiwa_app/Music/Widgets/GenreSongList.dart';
import 'package:wiwa_app/Music/Widgets/GenreSongsFilterWidget.dart';
...
class GenreSongs extends StatelessWidget {
  static const String id = 'genre-songs';
  @override
      ...
      headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
        return [
          SliverAppBar(
            ...
            snap: true,
            title: Text(
              _albumProvider.selectedSongGenre,
