...
class Utility {
  ...
  static Future<Uri> createLinkToShare(BuildContext context, String id,
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
        uriPrefix: 'https://wiwa.page.link',
        // link: Uri.parse('https://wiwa.com/$id'),
        link: Uri.parse('https://mywiwa.web.app/$id'),
        androidParameters: AndroidParameters(
          packageName: 'com.WiwaApp',
          minimumVersion: 0,
        ),
  ...
  static createLinkAndShare(BuildContext context, String id,
    ...
    share(url.toString(), subject: "Wiwa Post");
  }
