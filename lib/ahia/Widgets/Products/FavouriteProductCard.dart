...
class FavouriteProductCard extends StatelessWidget {
  ...
  FavouriteProductCard(this.document);
  @override
                ...
                child: InkWell(
                  onTap: () {
                    pushNewScreenWithRouteSettings(
                      context,
                      settings: RouteSettings(name: FavouriteProductDetails.id),
                      screen: FavouriteProductDetails(document: document),
                      withNavBar: true,
                  ...
                  Container(
                    child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('\NGN$_formatedPrice',
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(width: 10),
                              if (document['comparedPrice'] > document['price'])
                                Text('\NGN$_formatedComparedPrice',
                                    style: TextStyle(
