...
class _CounterForCardState extends State<CounterForCard> {
  ...
  String _docId;
  bool _exists = false;
  bool _deliveryAddressExists = false;

  bool _updating = false;

  // check if user is ahia customer

  // Future<void> checkDeliveryDetails() async {
  //   FirebaseFirestore.instance
  //       .collection('Ahia User')
  //       .doc(user.uid)
  //       .get()
  //       .then((DocumentSnapshot document) {
  //     if (document.exists) {
  //       setState(() {
  //         _deliveryAddressExists = true;
  //       });
  //     } else {
  //       _deliveryAddressExists = false;
  //     }
  //   });
  // }
        ...
        : StreamBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
              return
                  ...
                  //         },
                  //         child: Text("Set Delivery Address First",
