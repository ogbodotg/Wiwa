...
import 'package:wiwa_app/ahia/Widgets/Products/FavBottomSheetContainer.dart';
...
class FavouriteProductDetails extends StatefulWidget {
  static const String id = 'favourite-product-details';
  final DocumentSnapshot document;

  FavouriteProductDetails({this.document});

  @override
  _FavouriteProductDetailsState createState() =>
      _FavouriteProductDetailsState();
}

class _FavouriteProductDetailsState extends State<FavouriteProductDetails> {
  bool _loading = true;
  int _index = 0;
  int itemIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: FavBottomSheetContainer(widget.document),
      body: Padding(
                ...
                ? Column(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          //       //         color: Colors.grey.shade300),
                          //       //     imageProvider: NetworkImage(widget.document
                          //       //         .data()['productImages'][_index]),
                          //       //   ),
                          //       // ),
                          //       Positioned(
                          //         bottom: 0.0,
