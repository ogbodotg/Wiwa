...
import 'package:wiwa_app/widgets/tweet/widgets/tweetImage.dart';
  ...
  Widget _tweet(BuildContext context, FeedModel model) {
    return Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: model.videoPath == null ? 8 : 0),
        PostVideo(model: model, type: type, isRetweetVideo: true),
      ],
    );
  }
