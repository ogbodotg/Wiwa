...
import 'package:wiwa_app/widgets/tweet/widgets/postVideo.dart';
import 'package:wiwa_app/widgets/url_text/custom_link_media_info.dart';
...
import 'package:wiwa_app/widgets/tweet/widgets/parentTweet.dart';
import 'package:wiwa_app/widgets/tweet/widgets/tweetIconsRow.dart';
...
class Tweet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (searchState.userlist != null) {
      model.user.profilePic = searchState.userlist
          .firstWhere((x) => x.userId == model.user.userId)
          .profilePic;
    }
            ...
            children: <Widget>[
              ...
              model.childRetwetkey == null
                  ...
                  : RetweetWidget(
                      ...
                      isVideoAvailable:
                          model.videoPath != null && model.videoPath.isNotEmpty,
                    ),
              Padding(
                padding:
