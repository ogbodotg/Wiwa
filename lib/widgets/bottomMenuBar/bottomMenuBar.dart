...
import 'package:wiwa_app/widgets/bottomMenuBar/tabItem.dart';
        ...
        children: <Widget>[
          _icon(null, 0,
              icon: 0 == state.pageIndex
                  ? CustomIcon.home_1
                  : CustomIcon.home_outline,
              isCustomIcon: true),
          _icon(null, 1,
              icon: 1 == state.pageIndex
                  ? CustomIcon.search_1
                  : CustomIcon.search_outline,
              isCustomIcon: true),
          _icon(null, 2,
              icon: 2 == state.pageIndex
                  ? CustomIcon.music_1
                  : CustomIcon.music_outline,
              isCustomIcon: true),
          _icon(null, 3,
              icon:
                  3 == state.pageIndex ? CustomIcon.basket : CustomIcon.basket,
              isCustomIcon: true),
        ],
      ),
    );
