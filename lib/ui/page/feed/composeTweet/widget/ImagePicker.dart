...
class PostImagePicker extends StatefulWidget {
  ...
  // const PostImagePicker({Key key, this.urlList}) : super(key: key);
  @override
...
class _PostImagePickerState extends State<PostImagePicker> {
  ...
  Widget build(BuildContext context) {
    final _provider = Provider.of<ComposeProvider>(context);
    // widget.urlList.addAll(_provider.urlList);
    ...
    Future<String> uploadFile() async {
      ...
      try {
        await _storage.ref('PostImages/$timeStamp').putFile(file);
      ...
      String downloadURL =
          await _storage.ref('PostImages/$timeStamp').getDownloadURL();
      if (downloadURL != null) {
        setState(() {
          _image = null;
