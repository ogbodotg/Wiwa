...
class AlbumSongsOnProfileList extends StatefulWidget {
  final String uid;

  const AlbumSongsOnProfileList({Key key, this.uid}) : super(key: key);
  @override
  _AlbumSongsOnProfileListState createState() =>
      _AlbumSongsOnProfileListState();
}

class _AlbumSongsOnProfileListState extends State<AlbumSongsOnProfileList> {
