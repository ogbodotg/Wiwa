                      ...
                      if (snapshot.data.size == 0) {
                        return Center(
                          child: Text(tag > 0
                              ...
                              : 'No delivery agents yet (Work in progress)'),
                        );
                      }
                              ...
                              new ListTile(
                                onTap: () {
                                  ...
                                  _services
                                    ...
                                    name: document['deliveryAgentName'],
                                    image: document['deliveryAgentImage'],
                                ...
                                leading: CircleAvatar(
                                    ...
                                    child: Image.network(
                                        document['deliveryAgentImage'])),
                                title: new Text(document['deliveryAgentName'],
                                    style:
                                ...
                                subtitle: new Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'City/State: ${document['city'] + '-' + document['state']}'),
                                  ],
                                ),
                                trailing: Row(
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        _orderServices.launchEmail(
                                            'mailto:${document['email']}?subject=Delivery Agent Contact');
                                      },
                                    ),
                                  ],
                                ),
